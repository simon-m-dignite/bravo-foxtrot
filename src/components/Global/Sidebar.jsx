  ...
  return (
    ...
    >
      <div className="w-full horizontal-padding flex items-center justify-end gap-x-6 absolute top-6">
        <Link
          to="/contact-us"
          className="px-5 py-2 outline-none rounded-full text-sm font-medium flex items-center yellow-bg text-white"
        >
          Contact Us
          <TiArrowRight className="text-2xl" />
        </Link>
        <button onClick={onclick} className="">
          <IoClose className="text-3xl text-[#e0a56b]" />
        </button>
      </div>
      ...
      <div className="w-full absolute bottom-6 flex items-center justify-end gap-x-5 horizontal-padding">
        <Link
          ...
          className="text-[#e0a56b] text-lg"
        >
          <TiSocialFacebook className="text-[#e0a56b] text-lg" />
        </Link>
        <Link target="_blank" to={"https://www.instagram.com"}>
          <FaInstagram className="text-[#e0a56b] text-base" />
        </Link>
        <Link target="_blank" to={"https://www.twitter.com"}>
          <RiTwitterXLine className="text-[#e0a56b] text-base ml-1" />
        </Link>
      </div>
    </div>
  );
