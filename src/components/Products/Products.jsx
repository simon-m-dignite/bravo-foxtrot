...
const Products = () => {
  ...
  return (
    <section className="w-full py-12 lg:py-20 relative text-white bg-black overflow-hidden horizontal-padding">
      <motion.div
      ...
      <div className="w-full flex justify-center mt-28">
        <span className="border border-[#f79f1f] text-[#f79f1f] px-6 py-3 quantico-fonts">
          No More Products
        </span>
      </div>
    </section>
